...
#' rint_med.mkdata Creates the analytic dataset to compute NDEr, NIEr and TEr, the random interventional
...
#'
#' to do: extend to multiple confounders
#'
#' @param orig_dat The original dataset
#' @param X Text string containing the name of the exposure variable
...
#' @param L vector of text strings containing the name of exposure-induced confounder of M -> Y
...
#' rint_med.decompose: Random interventional analogue effects
#'
...
#' rint_med.boot: Random interventional analogue effects
#'
#' Computes NDEr, NIEr and TEr, the random interventional
#' analogues of the natural direct effect, natural indirect effect and total effect,
